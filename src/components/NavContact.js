...
function NavComponent() {
  return (
    <div
      className=" bg-gray-900 w-full h-10 lg:h-[25rem] lg:-my-[6rem] px-20 py-32 flex justify-center bg-fixed "
      style={{
    ...
    >
      <div className=" w-auto flex justify-center items-center  ">
        <div className="text-white text-3xl md:text-5xl font-thin  font-style ">
          ...
          <div>
        <p className=" font-thin lg:text-sm lg:w-[24rem] lg:bg lg:text-center text-center">
