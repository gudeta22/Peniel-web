        ...
        <div className="text-white lg:w-[95%]  lg:mx-2  h-auto  ">
          ...
          <div className="p-[1rem]  lg:my-8  rounded-x w-full  ">
            <span className="flex  lg:w-auto justify-center lg:mb-10   font-bold">
              <h2 className="my-4 lg:text-4xl font-bold font-mono   text-[#686868]">
                ABOUT PASTOR KINFEGEBREL MATHEWOS
              </h2>
            </span>
            <p className=" font-mono lg:text-lg text-sm space-y-[5px] fontstyle  text-[#1d2434 ] poppins font-normal text-[#686868]">
          ...
          <div className=" my-14  lg:my-24 md:w-auto  flex   sm:w-auto   rounded-xl lg:h-[28rem] lg:w-auto ">
            <iframe
